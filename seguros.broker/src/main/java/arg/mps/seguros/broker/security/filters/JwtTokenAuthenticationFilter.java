package arg.mps.seguros.broker.security.filters;
...
import arg.mps.seguros.broker.security.JwtConfig;
...
public class JwtTokenAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		logger.info("Encabezado de autenticacion -> header={}", header);	
		...
		logger.info("Se obtuvo el token -> token={}", token);
